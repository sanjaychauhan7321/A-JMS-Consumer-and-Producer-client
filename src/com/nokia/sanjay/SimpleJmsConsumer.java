...
public class SimpleJmsConsumer {
	...
	public static void main(String[] args) throws NamingException {
		...
		env.put(Context.SECURITY_PRINCIPAL, "sanjay123"); // username
		env.put(Context.SECURITY_CREDENTIALS, "sanjay123"); // password
		...
		while (null != text) {
			...
			try {
				...
				context = connectionFactory.createContext("sanjay123", "sanjay123"); // again, don't do this in
																						// production
				...
				if (null != text) {
					...
					System.out.println("Uh ho! You have got no messges! Hence no Chill "+"\u0002");
					break;
				}
			} finally {
